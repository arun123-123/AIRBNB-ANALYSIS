...
def datafr():
    df= pd.read_csv(r"C:\Users\HP\AKAIRBNB\Airbnb.csv")
    return df
...
if select == "Home":
    ...
    image1= Image.open(r"C:\Users\HP\Downloads\Airbnb logo vector - Logo Airbnb download.jpg")
    st.image(image1)
...
if select == "Data Exploration":
    ...
    with tab2:
        ...
        def datafr():
            df_a= pd.read_csv(r"C:\Users\HP\AKAIRBNB\Airbnb.csv")
            return df_a
